  ...
  return (
    <div className="min-h-screen bg-gradient-wellness flex items-center justify-center p-4">
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div className="absolute bottom-20 right-20 w-24 h-24 bg-secondary rounded-full animate-float" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-1/2 left-1/4 w-16 h-16 bg-accent rounded-full animate-float" style={{ animationDelay: '4s' }}></div>
      </div>
      ...
      <div className="w-full max-w-md relative">
        ...
        <Card className="glass shadow-wellness border-border/30">
          <Tabs defaultValue="signin">
            ...
            <TabsContent value="signup">
              <CardHeader className="pb-4">
                <CardTitle className="text-xl font-heading">Join WellnessSpace</CardTitle>
                <CardDescription>
          ...
          <div className="p-6 pt-0">
            <div className="flex items-start space-x-2 text-xs text-muted-foreground bg-wellness/50 p-3 rounded-lg">
              ...
              <p>
                Your data is encrypted and confidential. We follow strict privacy policies 
                to protect your mental health information.
              </p>
            </div>
          </div>
        </Card>
        ...
        <div className="mt-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-2 justify-center">
            <Button variant="outline" size="sm" className="border-accent text-accent-foreground hover:bg-accent/10">
              Call 988
            </Button>
            <Button variant="outline" size="sm" className="border-accent text-accent-foreground hover:bg-accent/10">
              Text HOME to 741741
